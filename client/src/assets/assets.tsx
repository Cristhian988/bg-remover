...
export const stepsData = [
  {
    ...
    title: "01. Subir",
    description:
      "Elige una imagen de tu dispositivo o arrástrala directamente al espacio de trabajo.",
    icon: upload_icon,
  },
  {
    id: 2,
    title: "02. Eliminación automática",
    description:
      "Nuestra red neuronal avanzada detecta y recorta al sujeto automáticamente en milisegundos.",
    icon: remove_bg_icon,
  },
  {
    id: 3,
    title: "03. Descargar",
    description:
      "Guarda al instante tu PNG en alta resolución con un  fondotransparente perfecto.",
    icon: download_icon,
  },
];
...
export const plans = [
  {
    ...
    price: 10,
    credits: 100,
    desc: "Ideal para uso personal.",
  },
  {
    id: "Avanzado",
    price: 50,
    credits: 500,
    desc: "Ideal para uso comercial.",
  },
  {
    id: "Negocios",
    price: 250,
    credits: 5000,
    desc: "Ideal para uso empresarial.",
  },
];
