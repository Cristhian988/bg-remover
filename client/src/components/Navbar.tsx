...
export const Navbar = () => {
  return (
    <div className="container flex items-center justify-between mx-auto py-3 px-6">
      ...
      <button className="bg-zinc-800 text-white flex items-center gap-4 px-4 py-2 sm:px-8 sm:py-3 rounded-full text-sm hover:scale-105 transition-all duration-700 cursor-pointer">
        Empezar{" "}
