...
`}table({tableData:t,tableOptions:n,tableBreakpoints:u}){return Wn(t.map(r=>r.map(s=>this.render(s))),u?Un(u):n)}flagParameter(t){return t===Boolean?"":t===String?"<string>":t===Number?"<number>":Array.isArray(t)?this.flagParameter(t[0]):"<value>"}flagOperator(t){return" "}flagName(t){const{flag:n,flagFormatted:u,aliasesEnabled:r,aliasFormatted:s}=t;let o="";if(s?o+=`${s}, `:r&&(o+="    "),o+=u,"placeholder"in n&&typeof n.placeholder=="string")o+=`${this.flagOperator(t)}${n.placeholder}`;else{const i=this.flagParameter("type"in n?n.type:n);i&&(o+=`${this.flagOperator(t)}${i}`)}return o}flagDefault(t){return JSON.stringify(t)}flagDescription({flag:t}){let n="description"in t?t.description??"":"";if("default"in t){let{default:u}=t;typeof u=="function"&&(u=u()),u&&(n+=` (default: ${this.flagDefault(u)})`)}return n}render(t){if(typeof t=="string")return t;if(Array.isArray(t))return t.map(n=>this.render(n)).join(`
...
`),{code:o.toString(),map:s.sourcemap?o.generateMap({hires:!0}):void 0}},"renderChunk"),writeBundle:l(async(u,r)=>{const s=new Set(Object.keys(r).map(o=>P(Y.join(u.dir,o))));await Promise.all(t.map(async({exportEntry:o})=>{const{outputPath:i}=o;s.has(i)&&await _.promises.chmod(i,493)}))},"writeBundle")}},"patchBinary"),Yt=l(e=>{const t=e.indexOf("/");if(t===-1)return[e,void 0];if(e[0]==="@"){const n=e.indexOf("/",t+1);return n===-1?[e,void 0]:[e.slice(0,n),e.slice(n+1)]}return[e.slice(0,t),e.slice(t+1)]},"parseSpecifier"),Zt=l(e=>{const t=e[0];return!(t==="."||t==="/"||t==="#"||g.isAbsolute(e))},"isBareSpecifier"),Ne=l((e,t=process.cwd())=>De(g.relative(t,e)).split("/").includes("node_modules"),"isFromNodeModules"),Qt=l(()=>{const e=/\.(?:[mc]?js|jsx)$/;return{name:"resolve-js-to-ts",async resolveId(t,n,u){if(n&&e.test(t)){if(!Ne(n)){const i=t.replace(/js(x?)$/,"ts$1");return this.resolve(i,n,u)}const r=await this.resolve(t,n,{...u,skipSelf:!0});if(r)return r;const s=t.replace(/js(x?)$/,"ts$1"),o=await this.resolve(s,n,{...u,skipSelf:!0});if(o)return o}return null}}},"resolveJsToTs"),Xt=l(e=>e!==null&&typeof e=="object","A"),K=l((e,t)=>Object.assign(new Error(`[${e}]: ${t}`),{code:e}),"a"),eu="ERR_INVALID_PACKAGE_CONFIG",Re="ERR_INVALID_PACKAGE_TARGET",Cr="ERR_PACKAGE_PATH_NOT_EXPORTED",Er=/^\d+$/,yr=/^(\.{1,2}|node_modules)$/i,Br=/\/|\\/;var tu=(e=>(e.Export="exports",e.Import="imports",e))(tu||{});const _e=l((e,t,n,u,r)=>{if(t==null)return[];if(typeof t=="string"){const[s,...o]=t.split(Br);if(s===".."||o.some(i=>yr.test(i)))throw K(Re,`Invalid "${e}" target "${t}" defined in the package config`);return[r?t.replace(/\*/g,r):t]}if(Array.isArray(t))return t.flatMap(s=>_e(e,s,n,u,r));if(Xt(t)){for(const s of Object.keys(t)){if(Er.test(s))throw K(eu,"Cannot contain numeric property keys");if(s==="default"||u.includes(s))return _e(e,t[s],n,u,r)}return[]}throw K(Re,`Invalid "${e}" target "${t}"`)},"f"),ee="*",wr=l((e,t)=>{const n=e.indexOf(ee),u=t.indexOf(ee);return n===u?t.length>e.length:u>n},"m");function br(e,t){if(!t.includes(ee)&&e.hasOwnProperty(t))return[t];let n,u;for(const r of Object.keys(e))if(r.includes(ee)){const[s,o,i]=r.split(ee);if(i===void 0&&t.startsWith(s)&&t.endsWith(o)){const a=t.slice(s.length,-o.length||void 0);a&&(!n||wr(n,r))&&(n=r,u=a)}}return[n,u]}l(br,"d");const vr=l(e=>Object.keys(e).reduce((t,n)=>{const u=n===""||n[0]!==".";if(t===void 0||t===u)return u;throw K(eu,'"exports" cannot contain some keys starting with "." and some not')},void 0),"p"),Ar=/^\w+:/,$r=l((e,t,n)=>{if(!e)throw new Error('"exports" is required');t=t===""?".":`./${t}`,(typeof e=="string"||Array.isArray(e)||Xt(e)&&vr(e))&&(e={".":e});const[u,r]=br(e,t),s=_e(tu.Export,e[u],t,n,r);if(s.length===0)throw K(Cr,t==="."?'No "exports" main defined':`Package subpath '${t}' is not defined by "exports"`);for(const o of s)if(!o.startsWith("./")&&!Ar.test(o))throw K(Re,`Invalid "exports" target "${o}" defined in the package config`);return s},"v");var xr=Object.defineProperty,h=l((e,t)=>xr(e,"name",{value:t,configurable:!0}),"o");function T(e){return e.startsWith("\\\\?\\")?e:e.replace(/\\/g,"/")}l(T,"h"),h(T,"slash");const We=h(e=>{const t=_[e];return(n,...u)=>{const r=`${e}:${u.join(":")}`;let s=n?.get(r);return s===void 0&&(s=Reflect.apply(t,_,u),n?.set(r,s)),s}},"cacheFs"),I=We("existsSync"),kr=We("readFileSync"),Fe=We("statSync"),uu=h((e,t,n)=>{for(;;){const u=g.posix.join(e,t);if(I(n,u))return u;const r=g.dirname(e);if(r===e)return;e=r}},"findUp"),Le=/^\.{1,2}(\/.*)?$/,Me=h(e=>{const t=T(e);return Le.test(t)?t:`./${t}`},"normalizeRelativePath");function nu(e,t=!1){const n=e.length;let u=0,r="",s=0,o=16,i=0,a=0,D=0,c=0,F=0;function f(p,b){let k=0,B=0;for(;k<p;){let E=e.charCodeAt(u);if(E>=48&&E<=57)B=B*16+E-48;else if(E>=65&&E<=70)B=B*16+E-65+10;else if(E>=97&&E<=102)B=B*16+E-97+10;else break;u++,k++}return k<p&&(B=-1),B}l(f,"y"),h(f,"scanHexDigits");function d(p){u=p,r="",s=0,o=16,F=0}l(d,"v"),h(d,"setPosition");function C(){let p=u;if(e.charCodeAt(u)===48)u++;else for(u++;u<e.length&&q(e.charCodeAt(u));)u++;if(u<e.length&&e.charCodeAt(u)===46)if(u++,u<e.length&&q(e.charCodeAt(u)))for(u++;u<e.length&&q(e.charCodeAt(u));)u++;else return F=3,e.substring(p,u);let b=u;if(u<e.length&&(e.charCodeAt(u)===69||e.charCodeAt(u)===101))if(u++,(u<e.length&&e.charCodeAt(u)===43||e.charCodeAt(u)===45)&&u++,u<e.length&&q(e.charCodeAt(u))){for(u++;u<e.length&&q(e.charCodeAt(u));)u++;b=u}else F=3;return e.substring(p,b)}l(C,"j"),h(C,"scanNumber");function m(){let p="",b=u;for(;;){if(u>=n){p+=e.substring(b,u),F=2;break}const k=e.charCodeAt(u);if(k===34){p+=e.substring(b,u),u++;break}if(k===92){if(p+=e.substring(b,u),u++,u>=n){F=2;break}switch(e.charCodeAt(u++)){case 34:p+='"';break;case 92:p+="\\";break;case 47:p+="/";break;case 98:p+="\b";break;case 102:p+="\f";break;case 110:p+=`
...
0&&(module.exports={${o.join(",")}});`),{code:i.toString(),map:i.generateMap({hires:!0})}}}}}},"cjsAnnotateExports"),ps=l((e,t,n,u,r,s)=>{const o=Object.fromEntries(e.env.map(({key:D,value:c})=>[`process.env.${D}`,JSON.stringify(c)])),i=Object.fromEntries(e.define.map(({key:D,value:c})=>[D,c])),a={target:e.target,sourcemap:e.sourcemap,tsconfigRaw:r?.config,define:{...o,...i}};return{input:{},preserveEntrySignatures:"strict",plugins:[Ht(e),...r?[Bu(r)]:[],Ku({entries:n}),vu(),as(),xu(t),Qt(),zu({extensions:[".mjs",".js",".ts",".jsx",".tsx",".json"],exportConditions:e.exportCondition}),Xr(),Ju(),Fr(a),fs(),qu({ignoreDynamicRequires:!0,extensions:[".js",".ts",".jsx",".tsx"],transformMixedEsModules:!0}),Gu({warnOnError:!0}),ns(),rs(s),...e.minify?[mr(a)]:[],gr(u)],output:[]}},"getPkgConfig"),ds=l(async(e,t,n)=>{const[u,r]=await Promise.all([import("./rollup-plugin-dts-Cax-OLNc.mjs"),import("./local-typescript-loader-CSvrvK-x.mjs")]);return{input:{},preserveEntrySignatures:"strict",plugins:[vu(),Ht(e),...n?[Bu(n)]:[],xu(t,{skipUnlistedWarnings:!0,forTypes:!0}),Qt(),u.default({respectExternal:!0,compilerOptions:{composite:!1,preserveSymlinks:!1,module:r.default.ModuleKind.Preserve,moduleResolution:r.default.ModuleResolutionKind.Bundler},tsconfig:n?.path})],output:[]}},"getDtsConfig"),Fs=l(e=>{if(e.length===0)return"";const t=e.map(s=>s.split("/")),n=t[0],u=Math.min(...t.map(s=>s.length)),r=[];for(let s=0;s<u;s+=1){const o=n[s];if(t.every(i=>i[s]===o))r.push(o);else break}return r.length===0?"/":r.join("/")||"/"},"getCommonPath"),hs=l(async(e,t,n,u,r,s)=>{const o=P(Fs(e.map(({dist:D})=>D)),!0);for(const D of e)D.distPrefix=D.dist.slice(o.length);const i=e,a=Object.create(null);for(const D of t){const{sourcePath:c,srcExtension:F,distExtension:f,exportEntry:d}=D,C=D.srcdist,m=C.distPrefix+c.slice(C.srcResolved.length,-F.length);if(D.inputNames=[m],d.format==="types"){let p=a.dts;p||(p=await ds(n,r,s),a.dts=p),p.input[m]||(p.input[m]=c);const b=p.output;if(b[f])b[f][X].inputNames.push(m);else{const k={dir:o,entryFileNames:`[name]${f}`,chunkFileNames:`${C.distPrefix}[name]-[hash]${f}`,exports:"auto",format:"esm",[X]:D};b.push(k),b[f]=k}continue}let w=a.pkg;if(!w){const p=i[0].dist;w=ps(n,r,u,t,s,p),a.pkg=w}w.input[m]||(w.input[m]=c);const O=w.output,$=`${d.format}-${f}`;if(O[$])O[$][X].inputNames.push(m);else{const p={dir:o,exports:"auto",format:d.format,sourcemap:n.sourcemap,entryFileNames:`[name]${f}`,chunkFileNames:`${C.distPrefix}[name]-[hash]${f}`,[X]:D};O.push(p),O[$]=p}}return Object.values(a)},"getRollupConfigs"),ms=l(e=>{if(!e)return _r();const t=g.resolve(e),n=du(t);return{path:t,config:n}},"getTsconfig"),gs=l(async e=>{await L(e)&&await _.promises.rm(e,{recursive:!0,force:!0})},"cleanDist"),Cs=/^[$_\p{ID_Start}][$\u200C\u200D\p{ID_Continue}]*$/u,Es=new Set(["do","if","in","for","int","new","try","var","byte","case","char","else","enum","goto","long","null","this","true","void","with","break","catch","class","const","false","final","float","short","super","throw","while","delete","double","export","import","native","public","return","static","switch","throws","typeof","boolean","default","extends","finally","package","private","abstract","continue","debugger","function","volatile","interface","protected","transient","implements","instanceof","synchronized"]),ys=l(e=>!Cs.test(e)||Es.has(e),"propertyNeedsQuotes"),Bs=l(e=>e.map((t,n)=>typeof t=="number"?`[${t}]`:ys(t)?`[${JSON.stringify(t)}]`:n>0?`.${t}`:t).join(""),"prettyPath"),ws=l(e=>({name:"filter-unnecessary-outputs",generateBundle:l((t,n)=>{const u=Object.keys(n).filter(o=>n[o].type==="chunk"),r=[];for(const o of u){const i=n[o];i.isEntry&&e.includes(i.name)&&r.push(o)}const s=new Set;for(;r.length>0;){const o=r.shift(),i=n[o];if(!i||s.has(o))continue;s.add(o);const a=[...i.imports,...i.dynamicImports];for(const D of a)r.push(D)}for(const o of u)s.has(o)||delete n[o]},"generateBundle")}),"filterUnnecessaryOutputs"),{stringify:ku}=JSON,ju=l(e=>{const[t,n]=e.split("=",2);return{key:t,value:n}},"keyValue"),N=Lt({name:"pkgroll",version:Qn,flags:{input:{type:[sr],alias:"i",description:"Dist paths for source files to bundle (Only use if you cannot use package.json entries)"},src:{type:String,description:"Source directory (Deprecated, use `srcdist` instead)",default:"./src"},dist:{type:String,description:"Distribution directory (Deprecated, use `srcdist` instead)",default:"./dist"},srcdist:{type:[String],description:"Source and distribution folder pairs (eg. default `src:dist`)"},minify:{type:Boolean,description:"Minify output",alias:"m",default:!1},target:{type:[String],default:[`node${process.versions.node}`],description:"Environments to support. `target` in tsconfig.json is automatically added. Defaults to the current Node.js version.",alias:"t"},tsconfig:{type:String,description:"Custom tsconfig.json file path",alias:"p"},watch:{type:Boolean,description:"Watch mode",alias:"w",default:!1},env:{type:[ju],description:"Compile-time environment variables (eg. --env.NODE_ENV=production)"},define:{type:[ju],description:"Targeted strings to replace (eg. --define.process.env.NODE_ENV='production')"},exportCondition:{type:[String],description:"Export conditions for resolving dependency export and import maps (eg. --export-condition=node)"},sourcemap:{type:l(e=>{if(e==="")return!0;if(e==="inline")return e;throw new Error(`Invalid sourcemap option ${ku(e)}`)},"type"),description:"Sourcemap generation. Provide `inline` option for inline sourcemap (eg. --sourcemap, --sourcemap=inline)"},cleanDist:{type:Boolean,description:"Clean dist before bundling",default:!1}},help:{description:"Minimalistic package bundler",render:l((e,t)=>(t.flagOperator=n=>n.name==="env"?".key=":" ",t.render(e)),"render")}}),Ou=process.cwd(),te=[];if(N.flags.srcdist.length>0)for(const e of N.flags.srcdist){const[t,n]=e.split(":",2);if(!t||!n)throw new Error(`Invalid src:dist pair ${ku(e)}. Expected format: src:dist`);te.push({src:P(t,!0),srcResolved:P(_.realpathSync.native(t),!0),dist:P(n,!0)})}else te.push({src:P(N.flags.src,!0),srcResolved:P(_.realpathSync.native(N.flags.src),!0),dist:P(N.flags.dist,!0)});const Su=ms(N.flags.tsconfig),Pu=Su?.config.compilerOptions?.target;Pu&&N.flags.target.push(Pu),(async()=>{const{packageJson:e}=await rr(Ou),t=await dr(te,e,N.flags.input);for(const r of t)if("error"in r){const{exportEntry:s}=r,o=typeof s.source=="string"?s.source:`${s.source.type}#${Bs(s.source.path)}`;console.warn(`Warning (${o}):`,r.error)}const n=t.filter(r=>!("error"in r));if(n.length===0)throw new Error("No entry points found");const u=await hs(te,n,N.flags,or(e,Ou),e,Su);N.flags.cleanDist&&await Promise.all(te.map(({dist:r})=>gs(r))),N.flags.watch?(ce("Watch initialized"),u.map(async r=>{Ru(r).on("event",async o=>{if(o.code==="BUNDLE_START"){const i=Array.isArray(o.input)?o.input:Object.values(o.input);ce("Building",...i.map(fe))}if(o.code==="BUNDLE_END"){await Promise.all(r.output.map(a=>o.result.write(a)));const i=Array.isArray(o.input)?o.input:Object.values(o.input);ce("Built",...i.map(fe))}o.code==="ERROR"&&ce("Error:",o.error.message)})})):await Promise.all(u.map(async r=>{const s=await _u(r);return Promise.all(r.output.map(o=>{const i=o[X].inputNames;return o.plugins=[ws(i)],s.write(o)}))}))})().catch(e=>{console.error(e),process.exit(1)});
